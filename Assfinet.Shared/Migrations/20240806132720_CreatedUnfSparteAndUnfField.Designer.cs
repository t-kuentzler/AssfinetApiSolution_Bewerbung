...
namespace Assfinet.Shared.Migrations
{
    ...
    [Migration("20240806132720_CreatedUnfSparteAndUnfField")]
    partial class CreatedUnfSparteAndUnfField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assfinet.Shared.Entities.UnfField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnfSparteId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UnfSparteId");

                    b.ToTable("UnfFields");
                });

            modelBuilder.Entity("Assfinet.Shared.Entities.UnfSparte", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assfinet.Shared.Entities.UnfField", b =>
                {
                    b.HasOne("Assfinet.Shared.Entities.UnfSparte", "UnfSparte")
                        .WithMany("UnfFields")
                        .HasForeignKey("UnfSparteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UnfSparte");
                });
