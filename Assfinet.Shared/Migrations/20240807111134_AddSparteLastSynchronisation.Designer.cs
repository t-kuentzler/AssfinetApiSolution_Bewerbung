...
namespace Assfinet.Shared.Migrations
{
    ...
    [Migration("20240807111134_AddSparteLastSynchronisation")]
    partial class AddSparteLastSynchronisation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assfinet.Shared.Entities.Sparte", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assfinet.Shared.Entities.SparteFields", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assfinet.Shared.Entities.SparteFields", b =>
                {
                    b.HasOne("Assfinet.Shared.Entities.Sparte", "Sparte")
                        .WithMany("SparteFields")
                        .HasForeignKey("SparteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
